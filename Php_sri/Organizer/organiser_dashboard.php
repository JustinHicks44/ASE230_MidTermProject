...
// ---------------------------------------
// SESSION-BASED ORGANIZER ID
// ---------------------------------------
// TODO: Replace with actual session when login is ready
// session_start();
// $organizerID = $_SESSION['userID'] ?? null;
// if (!$organizerID || $_SESSION['role'] !== 'Organizer') {
//     header('Location: ../login.php');
//     exit;
// }

$organizerID = 2;  // Temporary: OrganizerBob (from sample data)
